...
struct SymbolEntry *functionChain = NULL;
...
void insertFunction(char *name, function *level, int returnType, int arg0_type, char *arg0_name, int arg1_type, char *arg1_name, int arg2_type, char *arg2_name, int arg3_type, char *arg3_name)
{
    ...
    struct SymbolEntry *func = (struct SymbolEntry *)malloc(sizeof(struct SymbolEntry));
    memcpy(func, entry, sizeof(struct SymbolEntry));
    func->next = functionChain;
    functionChain = func;
}
